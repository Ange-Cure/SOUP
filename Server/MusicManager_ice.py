...
if 'MusicManagerPrx' not in _M_MusicServer.__dict__:
    ...
    class MusicManagerPrx(Ice.ObjectPrx):
        ...
        def pauseMusic(self, context=None):
            return _M_MusicServer.MusicManager._op_pauseMusic.invoke(self, ((), context))

        def pauseMusicAsync(self, context=None):
            return _M_MusicServer.MusicManager._op_pauseMusic.invokeAsync(self, ((), context))

        def begin_pauseMusic(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_MusicServer.MusicManager._op_pauseMusic.begin(self, ((), _response, _ex, _sent, context))

        def end_pauseMusic(self, _r):
            return _M_MusicServer.MusicManager._op_pauseMusic.end(self, _r)
    ...
    MusicManager._op_pauseMusic = IcePy.Operation('pauseMusic', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (), (), None, ())
